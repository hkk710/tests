...
$score=0;
	...
	$insert1_query = "INSERT INTO `athletics`.`RESULT_RELAY100F`(`DEPT`, `SCORE`) VALUES ('$chest1','$dist1')";
	$insert2_query = "INSERT INTO `athletics`.`RESULT_RELAY100F`(`DEPT`, `SCORE`) VALUES ('$chest2','$dist2')";
	$insert3_query = "INSERT INTO `athletics`.`RESULT_RELAY100F`(`DEPT`, `SCORE`) VALUES ('$chest3','$dist3')";
