...
$score=0;
	...
	$insert1_query = "INSERT INTO `athletics`.`RESULT_RELAY100M`(`DEPT`, `SCORE`) VALUES ('$chest1','$dist1')";
	$insert2_query = "INSERT INTO `athletics`.`RESULT_RELAY100M`(`DEPT`, `SCORE`) VALUES ('$chest2','$dist2')";
	$insert3_query = "INSERT INTO `athletics`.`RESULT_RELAY100M`(`DEPT`, `SCORE`) VALUES ('$chest3','$dist3')";

	$insert1 = mysqli_query($conn, $insert1_query);
	$insert2 = mysqli_query($conn, $insert2_query);
	$insert3 = mysqli_query($conn, $insert3_query);
//commented becoz individuals dont get team points
